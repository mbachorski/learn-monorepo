...
My info
------------
It is not working if device does not have activity to view the result file - and my piel 6 pro does not have one!
Also you have to add permissions manually to access phone storage before running app.
Charging control didn't work on emulator (work was paused) but worked on physical device.
